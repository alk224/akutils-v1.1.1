#!/usr/bin/env bash
#
#  chained_workflow-swarm.sh - OTU picking workflow using swarm (de novo)
#
...
## check whether user had supplied -h or --help. If yes display help 
	...
	if [[ "$1" == "--help" ]] || [[ "$1" == "-h" ]]; then
		...
		chained_workflow-swarm.sh config
...
echo "$otu_runtime
	...
	echo "		SWARM OTU picking already completed.
	"
fi
